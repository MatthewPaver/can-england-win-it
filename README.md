...
An interactive, explainable World Cup probability lab. Adjust England's form, finishing, midfield control and big-game nerve, then run 10,000 simulations of the 2026 semi-finals and final.
...
It is deliberately transparent: no black-box prediction, betting odds or invented certainty. Users choose the assumptions and the app shows how those assumptions move the outcome.

## Features

- 10,000 seeded Monte Carlo tournament simulations
- Elo-inspired matchup probabilities
- Four adjustable England performance factors
...
Each team starts with an illustrative strength rating. England's rating is adjusted using the four user controls. For every simulated tournament:
...
Tournament state and match results were checked against [FIFA's 2026 World Cup coverage](https://www.fifa.com/en/tournaments/mens/worldcup/canadamexicousa2026/). Team marks are original CSS treatments; no official logos or player photography are used.
